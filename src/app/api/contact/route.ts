...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      subject: `New Project Enquiry from ${name} (${country || 'Unknown'})`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #0C0C0C; color: #fff; border-radius: 12px;">
          <div style="margin-bottom: 24px;">
            <img src="https://esperpartners.vercel.app/logo.png" alt="Esper Partners" style="width: 40px; height: 40px; border-radius: 8px;" />
          </div>
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #0C0C0C; color: #fff; border-radius: 12px;">
          ...
          <p style="color: rgba(255,255,255,0.7); font-size: 15px; line-height: 1.7; margin-bottom: 16px;">
            We have received your enquiry about <strong style="color: #fff;">${project}</strong> and will get back to you within 48 hours with a clear proposal.
          </p>
          <p style="color: rgba(255,255,255,0.7); font-size: 15px; line-height: 1.7; margin-bottom: 32px;">
            In the meantime, you can book a free 30-minute discovery call directly in our calendar — it helps us understand your needs better and speeds up the proposal.
          </p>
