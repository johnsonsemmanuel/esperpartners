...
export default function Testimonials() {
  return (
    <section style={{ background: 'var(--bg)', overflow: 'hidden', paddingBottom: 0 }}>
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: '80px 20px 0' }}>
        <FadeIn><div className="text-[11px] font-bold tracking-[.14em] uppercase mb-4" style={{ color: 'var(--orange)' }}>Client Stories</div></FadeIn>
        <FadeIn delay={0.1}>
      ...
      <div className="relative overflow-hidden" style={{ marginTop: 44, paddingBottom: 64 }}>
        {/* Fade edges */}
        ...
        >
          {doubled.map((t, i) => (
            <div key={i} className="flex-shrink-0 rounded-[18px] border"
