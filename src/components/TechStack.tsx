  ...
  return (
    <div style={{ borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', background: 'var(--bg2)', overflow: 'hidden', padding: '36px 0' }}>
      ...
      <div className="marquee-track flex" style={{ width: 'max-content' }}>
        {doubled.map((t, i) => (
          <span key={i} className="flex items-center gap-3 px-9 font-syne font-bold text-[16px] tracking-[-0.02em] whitespace-nowrap transition-colors duration-300 select-none hover:text-white/60"
