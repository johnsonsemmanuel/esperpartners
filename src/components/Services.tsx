...
export default function Services() {
  ...
  return (
    <section id="features" ref={ref} className="px-5 md:px-10" style={{ padding: '80px 20px', background: 'var(--bg)' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto' }}>
        ...
        <div className="reveal d2 rounded-[16px] overflow-hidden flex flex-col md:grid md:rounded-[20px]"
